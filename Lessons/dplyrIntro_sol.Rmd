...
4. For the full data, create a summary of uptake by Treatment (the summary should include the mean, variance, minimum and maximum values).
5. For the full data, create a summary of uptake by both Treatment and Type.
...
CO2 %>% 
  ...
  summarise(uptake_mean=mean(uptake),
            uptake_var=var(uptake),
            uptake_min=min(uptake),
