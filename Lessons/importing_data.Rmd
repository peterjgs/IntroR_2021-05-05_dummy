...
2. Download the [`Sessile.csv`](https://www.dropbox.com/s/o50y3ferc2mdja1/Sessile.csv?dl=0) dataset and put it in your project directory (remember we created a project for this course earlier and you chose a directory). 
